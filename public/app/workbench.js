...
function getSessionOverviewCards() {
  ...
  return isFreshSession
    ...
    : [
        ...
        { key: 'Open TODOs', value: String(openTodos), action: "openSessionOverviewTodos()", clickable: typeof toggleTodoPopover === 'function', cardClass: openTodos > 0 ? 'card-todos' : 'card-neutral', tooltip: `${openTodos} open TODO item${openTodos === 1 ? '' : 's'}` },
        { key: 'Credentials', value: String(credentialCount), action: "openSessionOverviewLoot()", clickable: typeof toggleSvcPopover === 'function' && typeof switchSvcTab === 'function', cardClass: credentialCount > 0 ? 'card-credentials' : 'card-neutral', tooltip: `${credentialCount} cleartext/hash credential entr${credentialCount === 1 ? 'y' : 'ies'}` },
        { key: 'Ports', value: String(serviceCount), action: "openSessionOverviewPorts()", clickable: typeof toggleSvcPopover === 'function' && typeof switchSvcTab === 'function', cardClass: serviceCount > 0 ? 'card-ports' : 'card-neutral', tooltip: `${serviceCount} logged port/service entr${serviceCount === 1 ? 'y' : 'ies'}` },
        unassignedCount > 0
